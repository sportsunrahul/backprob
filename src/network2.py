...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        train_loss = np.linspace(0,0,epochs)
        val_loss = np.linspace(0,0,epochs)
        ...
        for j in range(epochs):
            ...
            print('Epoch {} training complete. Time Taken: {}'.format(j,(time.time()-start_time)))
            ...
            ## Plotting the losses
            # line1, = plt.plot(x_axis, train_loss,'b-',label="l1")
            # plt.hold(True)
            # line2, = plt.plot(x_axis, val_loss,'r-',label="l2")
